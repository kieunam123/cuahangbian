...
/**
 * Customize API: Almaira_Shop_Customize_Custom_Background_Control class
 *
...
class Almaira_Shop_Customize_Custom_Background_Control extends WP_Customize_Upload_Control{
	...
	public static function get_button_labels() {
		...
		$button_labels = array(
			'select'       => __( 'Select Image', 'almaira-shop' ),
			'change'       => __( 'Change Image', 'almaira-shop' ),
			'remove'       => __( 'Remove', 'almaira-shop' ),
			'default'      => __( 'Default', 'almaira-shop' ),
			'placeholder'  => __( 'No image selected', 'almaira-shop' ),
			'frame_title'  => __( 'Select Image', 'almaira-shop' ),
			'frame_button' => __( 'Choose Image', 'almaira-shop' ),
		);
	...
	public static function get_field_labels() {
		...
		$field_labels = array(
			'repeat'	=> __( 'Background Repeat', 'almaira-shop' ),
			'size'		=> __( 'Background Size', 'almaira-shop' ),
			'position'	=> __( 'Background Position', 'almaira-shop' ),
			'attach'	=> __( 'Background Attachment', 'almaira-shop' )
		);
	...
	public static function get_background_choices() {
		...
		$choices = array(
			'repeat' => array(
				'no-repeat' => __( 'No Repeat', 'almaira-shop' ),
				'repeat'    => __( 'Tile', 'almaira-shop' ),
				'repeat-x'  => __( 'Tile Horizontally', 'almaira-shop' ),
				'repeat-y'  => __( 'Tile Vertically', 'almaira-shop' )
			),
			'size' => array(
				'auto'    => __( 'Default', 'almaira-shop' ),
				'cover'   => __( 'Cover', 'almaira-shop' ),
				'contain' => __( 'Contain', 'almaira-shop' )
			),
			'position' => array(
				'left top'      => __( 'Left Top', 'almaira-shop' ),
				'left center'   => __( 'Left Center', 'almaira-shop' ),
				'left bottom'   => __( 'Left Bottom', 'almaira-shop' ),
				'right top'     => __( 'Right Top', 'almaira-shop' ),
				'right center'  => __( 'Right Center', 'almaira-shop' ),
				'right bottom'  => __( 'Right Bottom', 'almaira-shop' ),
				'center top'    => __( 'Center Top', 'almaira-shop' ),
				'center center' => __( 'Center Center', 'almaira-shop' ),
				'center bottom' => __( 'Center Bottom', 'almaira-shop' )
			),
			'attach' => array(
				'fixed'   => __( 'Fixed', 'almaira-shop' ),
				'scroll'  => __( 'Scroll', 'almaira-shop' )
			)
		);
