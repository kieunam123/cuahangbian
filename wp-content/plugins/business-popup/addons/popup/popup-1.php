...
echo "<div class='business-popupeditorpage-container'>";
	...
	echo $popup_editor->editor(['id'=>'overlay','title'=>__('Popup Setting','business-popup'),'image'=>['id'=>'popup-1']],$Overlay);
echo "</div>";

?>  
<div class="business-popup-save-html business__edit_outside-overlay" data-bid="1">
	<div class="business-popup-saved-message">
	    <div class="business-popup-saved-message-inner">
			...
			<?php echo $addonName['popup1']['setting']; ?>
</div>
